...
function trocar() {
        ...
        try {
            (async () => {
                ...
                console.log(" ▀  ▀ .▀▀▀  ▀  ▀  ▀▀▀▀ ·▀▀▀  ▀  ▀     ·▀▀▀▀  ▀▀▀ ▀▀ █▪".magenta)
                console.log("")
                console.log(`${'Current version: 1.3.9'.underline.magenta}`)
                console.log("")
                console.log(`${'Your imagination is your mind worst enemy'.underline.magenta}`)
                console.log(`[`.magenta, `>>`.green, `]`.magenta, ` The generator has been activated successfully.`)
                console.log("")
                console.log("Made by: ala$ca#4467")
                console.log("Rockstar Checked Chance: 23%")
                console.log("")
                console.log(`[`.magenta, `>>`.green, `]`.magenta, ` Valid Accounts:`.magenta, `${contas}`.brightWhite)
                console.log(`[`.magenta, `<<`.green, `]`.magenta, ` Unvalid Accounts:`.magenta, `${falhas}`.brightWhite)
                ...
                page.on('request', (req) => {
                    ...
                    if (from === 'noreply@rockstargames.com') {
                        ...
                        .setFooter('Ala$ca Gen')
                        .setColor('PURPLE');
                        hook1.send(embed)
                        contas++;
                        console.log(`[`.magenta, `>>`.green, `]`.magenta, ` A new valid account has been found.`)
                        console.log("")
                        browser.close();
                        quack();
